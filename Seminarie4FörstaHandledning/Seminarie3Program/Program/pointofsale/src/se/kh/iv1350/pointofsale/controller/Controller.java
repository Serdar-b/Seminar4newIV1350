...
public class Controller {
     ...
     * @throws ItemNotFoundException if the item searched does not exist,
     * for example entering wrong item id
     * @throws ServerConnectionFailException if the server is not running correctly
     */
    ...
    /**
     * Adds the observers to the observers list
     */
